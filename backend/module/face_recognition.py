...
from backend.module.addface_ import insert_data,save_json  # Importing function from addface.py
...
def app():
    ...
    with tab1:
        ...
        image = st.file_uploader("Upload Face Image", type=["jpg", "jpeg", "png"], key="add_image_key")  
            ...
            if image and email:
                ...
                if image_url:
                    ...
                    with open(JSON_FILE, "r") as file:
                        data = json.load(file)
                    insert_data(data)  # Call function to process face & insert into MySQL
        ...
        if saved_name and saved_email:
            ...
            if face_data:
                ...
                if face_data["image_url"]:
                    st.image(face_data["image_url"], caption="Face Image", use_column_width=True)
            else:
    ...
    with tab3:
        ...
        recognize_image = st.file_uploader("Upload Face Image", type=["jpg", "jpeg", "png"], key="recognize_image_key")  
                    ...
                    if data:
                        ...
                        if recognition_results:
                            ...
                            for res in recognition_results:
                                ...
                                st.image(res['uploaded_image'], caption="📷 Uploaded Image", use_column_width=True)
                                st.image(res['matched_image'], caption="📷 Matched Image", use_column_width=True)
