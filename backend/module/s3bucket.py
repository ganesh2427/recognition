...
def clean_file_name(file_name):
    ...
    file_name = re.sub(r"\.+", ".", file_name)  # Replace multiple dots with a single dot
...
def upload_to_s3(file_path, email):
    ...
    try:
        ...
        s3.upload_file(file_path, AWS_BUCKET_NAME, file_name, ExtraArgs={'ContentType': content_type})
